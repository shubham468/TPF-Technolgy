...
public class NewsDetails4 extends AppCompatActivity {
    ...
    private static String domain="wsj.com";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_news_details4);
        ...
        viewModel.getheadlinewallstreet(api,domain).observe(this, new Observer<NewsResponse>() {
            @Override
