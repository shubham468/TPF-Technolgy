...
public class NewsDetails1 extends AppCompatActivity {
    ...
    private static String category="business";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewModel.getheadlinebusiness(api,country,category).observe(this, new Observer<NewsResponse>() {
            @Override
