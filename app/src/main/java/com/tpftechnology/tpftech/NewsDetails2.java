...
public class NewsDetails2 extends AppCompatActivity {
    ...
    private static String from="2020-10-09";
    private static String to="2020-10-09";
    private static String q="apple";
    private static String sortBy="popularity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {finish();
                recyclerNewsheading.getRecycledViewPool().clear();}
        });
        recyclerNewsheading=findViewById(R.id.recyclerNewsheading);
        newsdetailProgress = findViewById(R.id.newsdetailProgress);

        viewModel.getheadlineApple(api,q,from,to,sortBy).observe(this, new Observer<NewsResponse>() {
            @Override
